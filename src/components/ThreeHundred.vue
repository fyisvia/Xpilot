...
const articles = ref([
  ...
  id: 29,
    round: '东 1 局  西家  6 巡目',
    images1: [z0, z0, m1, z0, z0, z0, z0],
    images2: [m6, m6, m6, m7, m8, p3, p4, p0, s3, s7, s7, z7, z7, m9],
    answerImg: s3,
    explanation: [
      '比', '起', '打', s7, '固', '定', '红', s5, '，', '更', '优', '先', '碰', '中', '或', '者', '成', '暗', '刻', '。',
      '在', '有', '祝', '仪', '的', '规', '则', '可', '能', '会', '比', '较', '抵', '触', '打', '掉', '赤', '牌', '，',
      '但', '同', '样', '是', '一', '番', '，', '速', '度', '完', '全', '不', '一', '样', '。',
      '饼', '子', '进', '张', '听', '牌', '的', '时', '候', '，', '基', '本', '都', '是', '打', '掉', '红', s5, '听', '对', '碰', '。'
    ]
  },
  {
  id: 30,
  ...
  id: 35,
    round: '东 1 局  西家  7 巡目',
    images1: [z0, z0, s1, z0, z0, z0, z0],
    images2: [m4, m5, m6, m7, p2, p2, p3, p5, p1, s6, s7, s7, s8, s8, p1],
    answerImg: p2,
    explanation: [
      '需', '要', '雀', '头', '。',
